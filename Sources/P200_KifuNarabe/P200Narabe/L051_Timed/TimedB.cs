...
namespace Grayscale.P200_KifuNarabe.L051_Timed
{
    ...
    public class TimedB : TimedAbstract
    {
        ...
        public static void Check_MouseoverKomaKiki(object obj_shogiGui, Finger finger, LarabeLoggerable logTag)
        {
            ...
            // 駒の利き
            SySet<SyElement> kikiZukei = Util_Sky.KomaKidou_Potential(finger, shogiGui.Model_PnlTaikyoku.GuiSkyConst);
        ...
        public TimedB(ShogiGui shogiGui)
        {
                                ...
                                case MouseEventStateName.Arive:
                                    {
                                        ...
                                        // メナス
                                        //------------------------------
                                        Util_Menace.Menace(this.shogiGui, eventState.Flg_logTag);
                                        #endregion
                                    }
                                    break;
                                ...
                                case MouseEventStateName.MouseMove:
                                    {
                                        ...
                                        foreach (Shape_BtnKomaImpl btnKoma in shogiGui.Shape_PnlTaikyoku.BtnKomaDoors)
                                        {
                                            ...
                                            if (btnKoma.Light)
                                            {
                                                ...
                                                {
                                                    // マウスオーバーした駒の利き
                                                    TimedB.Check_MouseoverKomaKiki(shogiGui, btnKoma.Koma, eventState.Flg_logTag);
                                ...
                                case MouseEventStateName.MouseLeftButtonDown:
                                    {
                                        ...
                                        // このメインパネルの反応
                                        //------------------------------
                                        shogiGui.Response("MouseOperation", eventState.Flg_logTag);
                                        #endregion
                                    }
                                    break;
                                        ...
                                        foreach (Shape_BtnKomaImpl btnKoma in shogiGui.Shape_PnlTaikyoku.BtnKomaDoors)
                                        {
                                            if (btnKoma.HitByMouse(eventState.MouseLocation.X, eventState.MouseLocation.Y))
                                            {
                                                ...
                                                if (Okiba.ShogiBan == Util_Masu.GetOkiba(koma1.Masu))
                                                {
                                                    ...
                                                    {
                                                        shogiGui.ChangeTurn(eventState.Flg_logTag);//マウス左ボタンを放したのでチェンジターンします。
                                                    }
                                ...
                                case MouseEventStateName.MouseLeftButtonDown:
                                    ...
                                    gt_EndKomaoki:
                                            ...
                                            Util_Masu.GetOkiba(btnSasitaiMasu.Zahyo)))//>>>>> 駒置き：升目
                                        {
                                            ...
                                            shogiGui.Model_PnlTaikyoku.SetGuiSky(new SkyConst(buffer_Sky));
