...
namespace Grayscale.P045_Atama.L050_KyHandan
{
    ...
    public class KyHandan_Ido : KyHandanAbstract
    {
        ...
        public override void Keisan(out KyHyokaItem kyokumenScore, KyHandanArgs args)
        {
            ...
            //    ((ShogiEngine)args.Owner).Log_Engine.WriteLine_AddMemo("駒[" + Haiyaku184Array.Name[(int)koma.Haiyaku].Trim() + "(No." + (int)((Atamanosumi)args.atamanosumi).Finger + ")]が、マス[" + Converter04.Masu_ToKanji(((Atamanosumi)args.Input_atamanosumi).Masu) + "]を目指したいんだぜ～☆。指し手が[" + sasite + "]なら、距離は[" + kyori + "]、スコアは[" + score + "]だぜ☆");
            //}
