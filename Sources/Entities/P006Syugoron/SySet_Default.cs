...
namespace Grayscale.P006_Syugoron
{
        ...
        where T1 : SyElement
    {
        ...
        public void Minus_Closed(T1 bElement)
        {
            // 要素から削除
            ...
            {
                thisSuperset.Minus_Closed(bElement);
            }
        }
        ...
        public void Minus_Opened(T1 bElement)
        {
            this.Minus_Closed(bElement);
        }
