...
namespace Grayscale.P025_KifuLarabe.L012_Common
{
    ...
    public abstract class KomanoKidou
    {
        ...
        {
            return KomanoKidou.SrcKeimatobi_戻跳(Converter04.AlternatePside( pside), masu_ji);
        }
        ...
        {
            return KomanoKidou.SrcKeimatobi_戻駆(Converter04.AlternatePside( pside), masu_ji);
        }
        ...
        public static SySet<SyElement> SrcKantu_戻上(Playerside pside, SyElement masu_itaru)
        {
            ...
            SyElement masu = Util_Masu.Offset(
        ...
        public static SySet<SyElement> SrcKantu_戻昇(Playerside pside, SyElement masu_itaru)
        {
            ...
            SyElement masu = Util_Masu.Offset(Okiba.ShogiBan, masu_itaru, pside, Hogaku.昇);
            if (Okiba.ShogiBan == Util_Masu.Masu_ToOkiba(masu))
            {
        ...
        public static SySet<SyElement> SrcKantu_戻射(Playerside pside, SyElement masu_itaru)
        {
            ...
            SyElement masu = Util_Masu.Offset(Okiba.ShogiBan, masu_itaru, pside, Hogaku.射);
            if (Okiba.ShogiBan == Util_Masu.Masu_ToOkiba(masu))
            {
        ...
        public static SySet<SyElement> SrcKantu_戻沈(Playerside pside, SyElement masu_itaru)
        {
            ...
            SyElement masu = Util_Masu.Offset(Okiba.ShogiBan, masu_itaru, pside, Hogaku.沈);
            if (Okiba.ShogiBan == Util_Masu.Masu_ToOkiba(masu))
            {
        ...
        public static SySet<SyElement> SrcKantu_戻引(Playerside pside, SyElement masu_itaru)
        {
            ...
            SyElement masu = Util_Masu.Offset(Okiba.ShogiBan, masu_itaru, pside, Hogaku.引);
            if (Okiba.ShogiBan == Util_Masu.Masu_ToOkiba(masu))
            {
        ...
        public static SySet<SyElement> SrcKantu_戻降(Playerside pside, SyElement masu_itaru)
        {
            ...
            SyElement masu = Util_Masu.Offset(Okiba.ShogiBan, masu_itaru, pside, Hogaku.降);
            if (Okiba.ShogiBan == Util_Masu.Masu_ToOkiba(masu))
            {
        ...
        public static SySet<SyElement> SrcKantu_戻滑(Playerside pside, SyElement masu_itaru)
        {
            ...
            SyElement masu = Util_Masu.Offset(Okiba.ShogiBan, masu_itaru, pside, Hogaku.滑);
            if (Okiba.ShogiBan == Util_Masu.Masu_ToOkiba(masu))
            {
        ...
        public static SySet<SyElement> SrcKantu_戻浮(Playerside pside, SyElement masu_itaru)
        {
            ...
            SyElement masu = Util_Masu.Offset(Okiba.ShogiBan, masu_itaru, pside, Hogaku.浮);
            if (Okiba.ShogiBan == Util_Masu.Masu_ToOkiba(masu))
            {
        ...
        public static SySet<SyElement> SrcIppo_戻上(Playerside pside, SyElement masu_itaru)
        {
            ...
            if (Playerside.P2 == pside)
            {
                ...
                SyElement masu = Util_Masu.Offset(Okiba.ShogiBan, masu_itaru, 0, 1);
                if (Okiba.ShogiBan == Util_Masu.Masu_ToOkiba(masu))
                {
        ...
        public static SySet<SyElement> SrcIppo_戻昇(Playerside pside, SyElement masu_itaru)
        {
            ...
            if (Playerside.P2 == pside)
            {
                ...
                SyElement masu = Util_Masu.Offset(Okiba.ShogiBan, masu_itaru, 1, 1);
                if (Okiba.ShogiBan == Util_Masu.Masu_ToOkiba(masu))
                {
        ...
        public static SySet<SyElement> SrcIppo_戻射(Playerside pside, SyElement masu_itaru)
        {
            ...
            if (Playerside.P2 == pside)
            {
                ...
                SyElement masu = Util_Masu.Offset(Okiba.ShogiBan, masu_itaru, 1, 0);
                if (Okiba.ShogiBan == Util_Masu.Masu_ToOkiba(masu))
                {
        ...
        public static SySet<SyElement> SrcKeimatobi_戻跳(Playerside pside, SyElement masu_itaru)
        {
            ...
            if (Playerside.P2 == pside)
            {
                ...
                SyElement masu = Util_Masu.Offset(Okiba.ShogiBan, masu_itaru, 1, -2);
                if (Okiba.ShogiBan == Util_Masu.Masu_ToOkiba(masu))
                {
            ...
            )
        {
            ...
            if (masuOrigin == Masu_Honshogi.Error)
            {
                goto gt_EndMethod;
            }
            ...
            if (Okiba.ShogiBan == Util_Masu.Masu_ToOkiba(masu1))
            {
                ...
                {
                    // 遷移
                    masu1 = (SyElement)Util_Masu.Offset(Okiba.ShogiBan, masu1, dSuji, dDan);
