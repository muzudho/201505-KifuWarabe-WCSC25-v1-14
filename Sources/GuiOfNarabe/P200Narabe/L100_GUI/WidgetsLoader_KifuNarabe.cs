    ...
    public class WidgetsLoader_KifuNarabe : WidgetsLoader
    {
        ...
        )
        {
...

            {
                ...
                FugoJ fugoJ;
                fugoJ = JFugoCreator15Array.ItemMethods[(int)Haiyaku184Array.Syurui(koma.Haiyaku)](move, new KyokumenWrapper(shogiGui.Model_PnlTaikyoku.GuiSkyConst));//「▲２二角成」なら、馬（dst）ではなくて角（src）。
